...
<!-- End Varify Script -->`;
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
      <div className="bg-[#121212] border border-gray-800 rounded-md p-6 w-full max-w-2xl">
        ...
        <div className="mb-6">
          <p className="text-gray-400 mb-3">
            Add this script to your website <code className="bg-black/30 px-1 py-0.5 rounded text-gray-300">&lt;head&gt;</code> tag to enable A/B testing for this project.
          </p>
          
          <div className="bg-gray-900 p-4 rounded-md border border-gray-800 relative">
            <pre 
              ref={codeRef}
            ...
            <button 
              onClick={handleCopy}
              className="absolute top-2 right-2 p-1.5 text-gray-400 hover:text-white rounded-md hover:bg-gray-800 transition-colors"
        ...
        <div className="space-y-4">
          ...
          <ol className="list-decimal pl-5 space-y-2 text-sm text-gray-300">
            ...
            <li>Paste it into your websites HTML, right before the closing <code className="bg-black/30 px-1 py-0.5 rounded text-gray-300">&lt;/head&gt;</code> tag.</li>
