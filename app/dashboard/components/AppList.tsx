...
export default function AppList() {
  ...
  if (loading) {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="bg-[#171717] border border-gray-800 rounded-md p-5 space-y-3">
  ...
  if (!apps || apps.length === 0) {
    return (
      <div className="border border-dashed border-gray-700 rounded-md bg-[#171717] p-10 text-center">
        ...
        <button
          ...
          className="px-4 py-2 rounded-md bg-[#39a276] text-white font-medium hover:bg-opacity-90 transition-colors"
        >
          New Project
        </button>
      </div>
    ...
    return (
      <div className="space-y-4">
        <button 
          ...
          className="flex items-center text-sm px-3 py-2 rounded-md text-white bg-[#1f1f1f] hover:bg-gray-800 transition-colors"
        >
